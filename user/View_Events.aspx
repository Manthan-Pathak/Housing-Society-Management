<%@ Page Title="" Language="C#" MasterPageFile="~/user/usr_home.master" AutoEventWireup="true" CodeFile="View_Events.aspx.cs" Inherits="user_View_Events" %>
...
--%>                            </div>
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                SelectCommand="SELECT * FROM [event_mstr] WHERE ([u_id] = @u_id)"
                                >
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="lbluid" Name="u_id" PropertyName="Text" 
                                                    Type="Int32" />
                                            </SelectParameters>
                            </asp:SqlDataSource>
