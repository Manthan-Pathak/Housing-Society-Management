<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin_home.master" AutoEventWireup="true" CodeFile="admdash.aspx.cs" Inherits="Admin_Default" %>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-auto">
                                ...
                                <h2 class="m-b-0">
                                    <asp:Label ID="lbl_ttlntc" runat="server" Text=""></asp:Label></h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-auto">
                                ...
                                <h2 class="m-b-0">
                                    <asp:Label ID="lbl_ttlcmplnt" runat="server" Text=""></asp:Label></h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                GridLines="None" Width="100%" DataKeyNames="uid">
